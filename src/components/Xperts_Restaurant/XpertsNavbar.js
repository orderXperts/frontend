  ...
  return (
    <div>
      <nav className="navbar navbar-expand-lg navbar custom-navbar-shadow" 
           style={{ backgroundColor: 'rgb(36 131 24)', zIndex: '10' }}>
            ...
            <div className="collapse navbar-collapse justify-content-center" id="navbarSupportedContent2" ref={navbarCollapseRef}>
              <ul className="navbar-nav mb-2 mb-lg-0">
                <li className="nav-item mx-2">
                  <HashLink className="nav-link" to="/FoodOrdering" onClick={handleNavLinkClick}>Food Ordering</HashLink>
                </li>
                <li className="nav-item mx-2">
                  <HashLink className="nav-link" to="/RestaurantService" onClick={handleNavLinkClick}>Restaurant Services</HashLink>
                </li>
                <li className="nav-item mx-2">
                  <HashLink className="nav-link" to="/Pricing" onClick={handleNavLinkClick}>Pricing</HashLink>
                </li>
                <li className="nav-item mx-2">
